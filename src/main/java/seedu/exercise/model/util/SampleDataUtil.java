...
public class SampleDataUtil {
    ...
    public static Exercise[] getBasicExercises() {
        return new Exercise[]{
            new Exercise(new Name("Push Ups"), Date.getToday(), new Calories("80"),
                new Quantity("100"), new Unit("counts"),
                getMuscleSet("Chest", "Triceps"), new TreeMap<>()),
            new Exercise(new Name("Sit ups"), Date.getToday(), new Calories("50"),
                new Quantity("100"), new Unit("counts"),
                getMuscleSet("Abs"), new TreeMap<>()),
            new Exercise(new Name("Squats"), Date.getToday(), new Calories("100"),
                new Quantity("100"), new Unit("counts"),
                getMuscleSet("Legs"), new TreeMap<>()),
            new Exercise(new Name("Run"), Date.getToday(), new Calories("300"),
